 ...
 *
 */
public class CDATAPrinter implements HierarchicalStreamWriter {
	...
	public CDATAPrinter(Writer writer, char[] lineIndenter) {
		this.writer = new QuickWriter(writer);
		this.lineIndenter = lineIndenter;
	}

	public CDATAPrinter(Writer writer, String lineIndenter) {
		this(writer, lineIndenter.toCharArray());
	}

	public CDATAPrinter(PrintWriter writer) {
		this(writer, new char[]{' ', ' '});
	}

	public CDATAPrinter(Writer writer) {
